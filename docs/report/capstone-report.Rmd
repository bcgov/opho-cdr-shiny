...
three rates are available as Crude or Age Standardized rates. Age
...
The design choices and intended use of the dashboard data product, integrating 
...
which made it challenging to display at an individual level in other report formats.
