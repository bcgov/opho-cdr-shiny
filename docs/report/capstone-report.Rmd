...
incidence rate of Gout in Kimberley CHSA is shown in
\@ref(fig:jp_method).

```{r jp_method, echo=FALSE, fig.cap="Estimated Age-standardized incidence rate of Gout in Kimberley CHSA", out.width = '100%'}
...
\#`` {r region-tab, echo=FALSE, fig.cap="Layout of the `By Region` tab of the dashboard, showing two graphs, and the top four diseases in a given region.", out.width = #'100%'} #knitr::include_graphics("images/region_tab.png") # ``
...
original distribution. The following figure \@ref(fig:jp_shiny shows the
...
```{r jp_shiny, echo=FALSE, fig.cap="Layout of the `Jointpoint Regression` tab of the dashboard", out.width = '100%'}
