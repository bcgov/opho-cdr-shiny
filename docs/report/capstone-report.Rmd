...
First, we build an Shiny dashboard that allows health professionals and non-experts alike to explore the distribution of diseases. It is fully interactive, user-friendly and visually appealing and consistent with the BC government's color scheme. We add interactivity that enrich the user experience, such as the hover information, linked highlighting effect. We also use methods to improve the app's performance on first start and during plots rendering. 
...
While we attempted to perfect the deliverables based on constant partner feedback, due to the short time frame of this capstone project, we acknowledge that there are areas we can improve on and we provide some recommendations on future endeavors. 
