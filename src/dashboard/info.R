################################
# This file defines the string constants 
#   for information statements
#   
# Note that the strings are in HTML formats
################################  
...
rate_info <-
  "Three different epidemiological rate types are available. The definitions of each are as follows. Note that for each definition,
...
disease_info <-
  "The BCCDR includes 25 chronic disease registries built and maintained by the Office
