...
hsc_diseases <- unique(hsc_prev_df$DISEASE)
...
```{r}
compare_models(life_prev_df, "1110 Fernie", "Age-Std Life Prevalence")
```

### Standardized HSC Prevalence in Fernie
```{r}
compare_models(hsc_prev_df, "1110 Fernie", "Std HSC Prevalence")
```
