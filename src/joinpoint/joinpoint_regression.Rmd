...
The following graph plots Age-standardized Incidence Rate of ALZHEIMER_DEMENTIA in from 2001 to 2020  (Will label the graph)
...
regression models.
```{r aapc}
print(aapc(seg_model, wrong.se = FALSE))
```
Observations: (Will elaborate later)
...
```{r}
plot(seg_model, conf.level=.95, is=TRUE, isV=FALSE, col=1, shade = TRUE, res=TRUE, res.col=1, pch=19)
```

Observations: (Will elaborate later)

 - Epidemiological emphasis: Causes can be explored looking at the "Breakpoint" of Year 2004
