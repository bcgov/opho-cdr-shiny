...
Explore trends in rates as per diseases and regions

```{r eda}

# pic <- df %>% 
#   plot_ly(type = 'scatter', mode = 'lines') %>%
#   add_trace(x = ~YEAR, y = ~STD_RATE_PER_1000, name = 'STD_RATE_PER_1000') 
# 
# 
# df <- highlight_key(df)
# 
# widgets <- bscols(
#   widths = c(12),
#   filter_select("DISEASE", "Choose Variable", df, ~DISEASE)
# )
# 
# bscols(
