...
for (DISEASE in names(HSC_df_list)) {
    write.csv(HSC_df_list[[DISEASE]], paste0("HSCPrevalence/", DISEASE, ".csv"), row.names = FALSE)
}
...
for (DISEASE in names(LifeP_df_list)) {
    write.csv(LifeP_df_list[[DISEASE]], paste0("LifePrevalence/",DISEASE, ".csv"),row.names=FALSE)
}
