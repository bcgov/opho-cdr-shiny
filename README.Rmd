...
5. To view the temporal model visualizations in a Shiny document, check that results have been output to "results/model". 
    ...
    ```
6. To view the Joinpoint Regression results, check that results have been output to "results/model". 
  To veiw the method paper, run the following command in the R console:
    ```
...
│   ├── dashboard                         
|   │   ├── data                              
|   │   |   ├── model                         # Data from Temporal Modelling and Joinpoint
|   │   |   |   ├── HSCPrevalence  
|   │   |   |   |   ├── AMI_EPI.csv 
|   │   |   |   |   ├── ASTHMA_EPI.csv 
|   │   |   |   |   └── ...
